DATA_CSVFILEPATH = 'ind-diff-regression.csv'
...
MAX_HISTOGRAM_BINSIZE = 50
HISTOGRAM_BINSIZE_INCREMENT = 5 # controls how many tick marks there are on the bin size slider